...
- **Input Sanitization:** Direct superglobals (# 🎓 Moodle Question Bank Plugin: Competency (`qbank_competency`)
...
GET, # 🎓 Moodle Question Bank Plugin: Competency (`qbank_competency`)
...
- **Copyright:** © 2026 Mahmoud Salem
- **License:** Licensed under the [GNU GPL v3 License](http://www.gnu.org/copyleft/gpl.html) (or later).
POST, # 🎓 Moodle Question Bank Plugin: Competency (`qbank_competency`)
